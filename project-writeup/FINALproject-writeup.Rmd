...
After conducting a backward selection, we we found that sex, age population, HDI, gdp for year, and gdp per capita, and region are relevant predictors, whereas population, continent, and generation are not (See Figure 13).
