...
```{r}
donor <- data.frame(country=c("Republic of Korea", "Russian Federation"), "HDI"=c(.884, .780))

names(suicideFinal)[names(suicideFinal) == 'HDI for year'] <- 'HDI'
```
Online, we can find the HDI from 2010 of South Korea and Russia, which are .884 and .780 respectively. We will do these after 

Since the HDI's of Puerto Rico and Aruba, since those we will find use the average HDI from that region to impute. 
