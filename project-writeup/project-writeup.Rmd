...
-interpret economic situations for prediction
-pick different types of countries -- rich and poor to predict on
-region with other variables as interactions 
-can use regions unless there are too many but defo dont use countries
